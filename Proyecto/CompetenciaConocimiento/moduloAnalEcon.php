...
<head>
    ...
    <link rel="stylesheet" href="../Estilos/EstilosComp1/modulo3.css">
...
<body>
    ...
    <nav class="submenu">
        ...
        <ul class="modulos">
            ...
            <li><a href="http://localhost/Proyecto/CompetenciaConocimiento/moduloGestion.php" class="mod2">Gestion de organizaciones</a></li>
            <li><a href="#competencia-2" class="mod3">Analisis economico</a></li>
        </ul>
    </nav>
