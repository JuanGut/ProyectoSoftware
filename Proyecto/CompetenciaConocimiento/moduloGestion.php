...
<head>
    ...
    <link rel="stylesheet" href="../Estilos/EstilosComp1/modulo2.css">
...
<body>
    ...
    <nav class="menu1">
        ...
        <ul class="competencias">
            <li><a href="" class="comp1">Conocimiento</a></li>
    ...
    <nav class="submenu">
        ...
        <ul class="modulos">
            <li><a href="http://localhost/Proyecto/contenidoCompetencias.php" class="mod1">Informacion contable</a></li>
            <li><a href="#competencia-1" class="mod2">Gestion de organizaciones</a></li>
            <li><a href="http://localhost/Proyecto/CompetenciaConocimiento/moduloAnalEcon.php" class="mod3">Analisis economico</a></li>
        </ul>
    </nav>
