...
<head>
    ...
    <link rel="stylesheet" href="../Estilos/Resultados/resultado3.css">
    <title>Resultado evaluacion</title>
</head>
<body>
    <nav id="Nav">
        <div id="Contenedor">
            <img src="../Recursos/iconoU.png" id="u" class="img1">
            <h1  class="titulo1"> Visualizar resultados </h1>
    ...
    <nav class="menu1">
        ...
        <ul class="competencias">
            <li><a href="http://localhost/Proyecto/Resultados/resultado1.php" class="comp1">Conocimiento</a></li>
            <li><a href="http://localhost/Proyecto/Resultados/resultado2.php" class="comp2">Competencias Digitales</a></li>
            <li><a href="" class="comp3">Habilidades Blandas</a></li>
        </ul>
    </nav>
    <br>
    ...
    <br>
    <input type="submit" name="Salir" id="btnsalir" value="Salir">
    <br>
    <br>
    <br>
