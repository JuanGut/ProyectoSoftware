...
<head>
    ...
    <link rel="stylesheet" href="../Estilos/Resultados/resultado2.css">
...
<body>
    ...
    <nav class="menu1">
        ...
        <ul class="competencias">
            ...
            <li><a href="http://localhost/Proyecto/Resultados/resultado3.php" class="comp3">Habilidades Blandas</a></li>
        </ul>
    </nav>
    <br>
