...
<head>
    ...
    <link rel="stylesheet" href="../Estilos/EstilosComp2/modulo1.css">
...
<body>
    ...
    <nav class="menu1">
        ...
        <ul class="competencias">
            ...
            <li><a href="#competencia-1" class="comp2">Competencias Digitales</a></li>
    ...
    <nav class="submenu">
        ...
        <ul class="modulos">
            <li><a href="#competencia-2" class="mod1">Conocimiento digital</a></li>
            ...
            <li><a href="http://localhost/Proyecto/CompetenciasDigitales/aprendizajeContinuo.php" class="mod4"> Aprendizaje continuo</a></li>
        </ul>
    </nav>
