...
<head>
    ...
    <link rel="stylesheet" href="../Estilos/EstilosComp2/modulo2.css">
...
<body>
    ...
    <nav class="menu1">
        ...
        <ul class="competencias">
            ...
            <li><a href="" class="comp2">Competencias Digitales</a></li>
    ...
    <nav class="submenu">
        ...
        <ul class="modulos">
            <li><a href="http://localhost/Proyecto/CompetenciasDigitales/conocimientoDigital.php" class="mod1">Conocimiento digital</a></li>
            <li><a href="http://localhost/Proyecto/CompetenciasDigitales/comunicacionDigital.php" class="mod2">Comunicacion digital</a></li>
            <li><a href="http://localhost/Proyecto/CompetenciasDigitales/liderazgoRed.php" class="mod3">Liderazgo en red</a></li>
            <li><a href="http://localhost/Proyecto/CompetenciasDigitales/aprendizajeContinuo.php" > Aprendizaje continuo</a></li>
        </ul>
    </nav>
